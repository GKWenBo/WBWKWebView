...
- (void)initCustomWebView {
    ...
    _webView = [[WBWKWebView alloc] initWithURL:url];
    _webView.showProgress = NO;
    _webView.webView.navigationDelegate = self;
...
- (void)viewDidLayoutSubviews {
    ...
    _webView.frame = CGRectMake(0, 88, self.view.bounds.size.width, self.view.bounds.size.height - 88);
}
...
//    [webView wb_addClickEventOnImg];
    ...
    [_webView getMaxDocumentBodyScrollHeight:^(CGFloat height) {
